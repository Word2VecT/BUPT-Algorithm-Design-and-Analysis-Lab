...
{
    // 构造文件名
    std::string filename = "/Users/tang/Course/算法设计与分析/Lab/Lab 1/random_numbers/sorted_numbers_" + std::to_string(nDefaultCount) + ".txt";
    ...
    filename = "/Users/tang/Course/算法设计与分析/Lab/Lab 1/times/determine_continue_khalfn_sorted_" + std::to_string(nDefaultCount) + ".txt";
