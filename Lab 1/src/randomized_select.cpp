...
int main()
{
    ...
    filename = "/Users/tang/Course/算法设计与分析/Lab/Lab 1/times/random_" + std::to_string(nDefaultCount) + ".txt";
    ...
    for (int i = 1; i <= kTimes; ++i) {
        ...
        for (int j = 0; j < trials; ++j) {
            ...
            // 调用快速选择算法
            quickSelect(nums_copy, 0, static_cast<int>(nums.size()) - 1, k_count, gen);
